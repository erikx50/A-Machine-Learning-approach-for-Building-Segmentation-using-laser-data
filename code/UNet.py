...
def unet_test1(input_size=(512, 512, 3)):
    ...
    model.compile(optimizer=optimizers.Adam(learning_rate=0.00001), loss=losses.BinaryFocalCrossentropy(alpha=0.25, gamma=2.0), metrics=[jaccard_coef, 'accuracy'], loss_weights=[1, 10])
    return model
