from keras import models, layers, optimizers, callbacks, losses, metrics, backend, Model
...
def unet_large(input_size=(512, 512, 3)):
    ...
    u6 = layers.Conv2D(512, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(layers.UpSampling2D(size = (2,2))(c5))
    ...
    u7 = layers.Conv2D(256, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(layers.UpSampling2D(size = (2,2))(c6))
    ...
    u8 = layers.Conv2D(128, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(layers.UpSampling2D(size = (2,2))(c7))
    ...
    u9 = layers.Conv2D(512, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(layers.UpSampling2D(size = (2,2))(c8))
...
def unet_small(input_size=(512, 512, 3)):
    ...
    u6 = layers.Conv2D(128, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(tf.keras.layers.UpSampling2D(size = (2,2))(c5))
    u6 = layers.concatenate([u6, c4])
    ...
    u7 = layers.Conv2D(64, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(tf.keras.layers.UpSampling2D(size = (2,2))(c6))
    u7 = layers.concatenate([u7, c3])
    ...
    u8 = layers.Conv2D(32, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(tf.keras.layers.UpSampling2D(size = (2,2))(c7))
    u8 = layers.concatenate([u8, c2])
    ...
    u9 = layers.Conv2D(16, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(tf.keras.layers.UpSampling2D(size = (2,2))(c8))
    u9 = layers.concatenate([u9, c1], axis=3)
